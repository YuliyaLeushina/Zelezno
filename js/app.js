(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeSlider) {
                ...
                rangeSlider.noUiSlider.on("update", (function(values, handle) {
                    inputs[handle].value = Number(values[handle]).toFixed(1);
                }));
        ...
        function rangeInitPrice() {
            const rangeSliderPrice = document.getElementById("range-sliderPrice");
            if (rangeSliderPrice) {
                ...
                const input0 = document.getElementById("input-3");
